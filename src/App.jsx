          ...
          <div className="footer-top">
            <div className="footer-brand">
              ...
              <div className="social-links">
                <a href="https://www.instagram.com/gokul_bsgk/" className="social-icon" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://www.linkedin.com/in/bsgk/" className="social-icon" target="_blank" rel="noopener noreferrer">
                  <svg viewBox="0 0 24 24" fill="currentColor">
